...
public class EventHandlers {
    ...
    public abstract static class MfgResultNotifyProgressReportHandler implements IEventHandler<MfgResultNotifyProgressReportDTO> {
        @Override
    ...
    public abstract static class MfgResultNotifyProgressReportAdjustHandler implements IEventHandler<MfgResultNotifyProgressReportAdjustDTO> {
        @Override
    ...
    public abstract static class MfgResultNotifyFeedingRetractHandler implements IEventHandler<MfgResultNotifyFeedingRetractDTO> {
        @Override
    ...
    public abstract static class MedResultNotifyProduceTaskDispatchHandler implements IEventHandler<MedResultNotifyProduceTaskDispatchDTO> {
        @Override
    ...
    public abstract static class PloResultNotifyProductionWorkOrderLaunchHandler implements IEventHandler<PloResultNotifyProductionWorkOrderLaunchDTO> {
        @Override
    ...
    public abstract static class InventoryResultNotifyOutboundHandler implements IEventHandler<InventoryResultNotifyOutboundDTO> {
        @Override
    ...
    public abstract static class InventoryResultNotifyInboundHandler implements IEventHandler<InventoryResultNotifyInboundDTO> {
        @Override
    ...
    public abstract static class InventoryResultNotifyTransferHandler implements IEventHandler<InventoryResultNotifyTransferDTO> {
        @Override
    ...
    public abstract static class InventoryResultNotifyTransferIssueHandler implements IEventHandler<InventoryResultNotifyTransferIssueDTO> {
        @Override
    ...
    public abstract static class InventoryResultNotifyTransferReceiveHandler implements IEventHandler<InventoryResultNotifyTransferReceiveDTO> {
        @Override
    ...
    public abstract static class InventoryResultNotifyAdjustHandler implements IEventHandler<InventoryResultNotifyAdjustDTO> {
        @Override
    ...
    public abstract static class InventoryResultNotifyPostingHandler implements IEventHandler<InventoryResultNotifyPostingDTO> {
        @Override
    ...
    public abstract static class QualityResultNotifyQcTaskHandler implements IEventHandler<QualityResultNotifyQcTaskDTO> {
        @Override
    ...
    public abstract static class QualityResultNotifyChangeQcStatusHandler implements IEventHandler<QualityResultNotifyChangeQcStatusDTO> {
        @Override
