...
public class MaterialStorageAttrCreateRequestDTO {
    /**
     * id
     */
    private Long id;
    ...
    /**
     * 属性名称 供应商批次、供应商、客户、生产日期、有效期至、入厂日期、货主
     */
    private String name;
    ...
    public void setNullEnable(Integer nullEnable) {
