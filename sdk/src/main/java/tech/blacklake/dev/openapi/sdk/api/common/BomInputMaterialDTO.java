...
public class BomInputMaterialDTO  {
    /**
     * 父项物料编号,不可超过255个字符
     */
     ...
     * 子项物料行
     */
    private List<BomInputMaterialLineDTO> bomInputMaterialLines;
    ...
    public List<BomInputMaterialLineDTO> getBomInputMaterialLines() {
    ...
    public void setBomInputMaterialLines(List<BomInputMaterialLineDTO> bomInputMaterialLines) {
