...
public class BomDetailResponseDTO  {
     ...
     * 多产出
     */
    private List<BomOutputMaterialDetailResponseDTO> bomOutputMaterials;
    ...
    public List<BomOutputMaterialDetailResponseDTO> getBomOutputMaterials() {
    ...
    public void setBomOutputMaterials(List<BomOutputMaterialDetailResponseDTO> bomOutputMaterials) {
